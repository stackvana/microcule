...
//
Store.prototype.zscore = function zscore (zset, member, cb) {
  this.get(zset + '/' + member, cb)
};
Store.prototype.zincrby = function zincrby (args, cb) {
...
Store.prototype.sadd = function sadd (key, value, cb) {
...
Store.prototype.zadd = function zadd (set, member, val, cb) {
...
Store.prototype.hgetall = function hgetall (key, cb) {
  cb(null, this.services[key]);
};

Store.prototype.hincrby = function hincrby (key, field, value, cb) {
  this.services[key] = this.services[key] || {};
