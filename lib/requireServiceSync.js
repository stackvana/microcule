...
// Params:
//      opts: object {path: string} fully qualified path to code being executed. Folder or file including ext.
//
...
//console.log('in loadService()')
  ...
  //console.log('##### inside requireServiceSync() ####');
  //console.dir(service);
  return service;
 }